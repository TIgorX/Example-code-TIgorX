...
public class AutoCam : PivotBasedCameraRig
{
    ...
    [SerializeField] public bool followVelocity = false;   		// Whether the rig will rotate in the direction of the target's velocity.
    [SerializeField] public bool followTilt = true;        		// Whether the rig will tilt (around X axis) with the target.
